...
let vitalsignList: Array<string> = ["systolic", "diastolic", "glucose", "spo2", "heart_rate"] // heartRate is not now
let vitalsignThaiList: Array<string> = ["ความดันโลหิตเมื่อหัวใจบีบตัว", "ความดันโลหิตเมื่อหัวใจคลายตัว", "ระดับน้ำตาลในเลือด", "ความเข้มข้นของออกซิเจนในเลือด", "อัตราการเต้นของหัวใจ"]
...
class RiskLevelUI extends Component<any, any> {
    ...
    render() {
        ...
        return (
            <div>
                <h3> เกณฑ์การจำแนกระดับความเสี่ยง </h3>
                <hr />
